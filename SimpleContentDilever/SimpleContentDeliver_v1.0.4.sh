...
Server_Count=1
Server0_Address=192.168.40.11,/home/castis/test
Log_Directory=/var/log/castis/Simple
Watch_Period_Sec=5
Watch_Directory=/home/castis/test
Temp_Directory=/home/castis/test/temp
Max_Count=3
...
version=SimpleContentDeliver_v1.0.3
...
do
        ...
        then
                ...
                ls $Temp_Directory | grep .mpg > $Temp_Directory/.remote_move_list_temp
